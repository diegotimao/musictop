      ...
      <div className='bg-white w-full p-10 sm:max-w-xl md:max-w-2xl
        ...
        <form action="" className='flex flex-col gap-5'>
          <label htmlFor="" className='flex flex-col gap-2'>
            Email
            <input type="text" placeholder='Digite seu email aqui' className='w-full border border-gray-500 h-14 rounded-md pl-12 relative focus:outline-none 
          ...
          <label htmlFor="" className='flex flex-col gap-2'>
            Senha
            <input type="password" placeholder='Digite seu email aqui' className='w-full border border-gray-500 h-14 rounded-md pl-12 relative focus:outline-none 
              focus:border-sky-500 focus:ring-1 focus:ring-sky-500
              disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none
              invalid:border-pink-500 invalid:text-pink-600
              focus:invalid:border-pink-500 focus:invalid:ring-pink-500
